    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            doc = Jsoup.connect(paramUrl)
                    ...
                    .data("bbsId", "BBSMSTR_000000002720")
                    .post();
            //쿠키셋팅
            doc1 = Jsoup.connect(paramUrl)
                    ...
                    .header("Accept-Language", "ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7")
                    .cookies(resultCookies)
                    .data("bbsId", "BBSMSTR_000000002721")
                    .post();
            //쿠키셋팅
            ...
            doc2 = Jsoup.connect("https://doosan.sen.es.kr/10107/subMenu.do")
                    .userAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36")
                    .timeout(3000)
                    .header("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7")
                    .header("Content-Type", "application/x-www-form-urlencoded")
            ...
            doc3 = Jsoup.connect("https://doosan.sen.es.kr/10107/subMenu.do")
                    .userAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36")
                    .timeout(3000)
                    .header("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7")
                    .header("Content-Type", "application/x-www-form-urlencoded")
            ...
            doc4 = Jsoup.connect("https://doosan.sen.es.kr/10107/subMenu.do")
                    .userAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36")
                    .timeout(3000)
                    .header("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7")
                    .header("Content-Type", "application/x-www-form-urlencoded")
